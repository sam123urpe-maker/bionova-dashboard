      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <Image
            ...
            priority
          />
          <h1 className="text-xl font-semibold text-slate-800 dark:text-slate-200">Iniciar sesion</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-center text-sm text-slate-400 dark:text-slate-500">
            No tienes cuenta?{" "}
            <Link href="/registro" className="text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 font-medium">
              Registrate
            </Link>
          </p>
        </form>
